...
2. How to generate the figures for both the Fig.4 (Gantt Chart) and Fig.5a (The profit of the cooperative obtained with PDRL and heuristic searching)
(1) In Parameter.py, configure parameters as follows:
...
3. How to generate the Fig.5b and Fig.5c (Agricultural knowledge acquired through the PDRL algorithm)
(1) In Parameter.py, configure parameters as follows:
SamePolicyDifferetPro = True #if True, comparing Cooperatives Adopting Different Strategies
...
4. How to generate the Fig.5d ( Dynamic planning process using PRDL)
(1) In Parameter.py, configure parameters as follows:
SamePolicyDifferetPro = True #if True, comparing Cooperatives Adopting Different Strategies
ConsiderMiniSupply = True # if True, considering Diversity (Market) Constraint
